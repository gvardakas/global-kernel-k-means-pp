...
class KernelKMeansPP:
    ...
    def custom_kernel_kmeans(self, X, clusters_labels, initial_partition, kernel_matrix, max_iter=300, tol=1e-4):
        n_samples = X.shape[0]
    ...
    def kernel_kmeans_pp(self, X, K, kernel_matrix, n_init=1, method = 'KkMeans++'):
        ...
        for _ in range(n_init):
            ...
            partition, total_error = self.custom_kernel_kmeans(X, clusters_labels, initial_partition = partition, kernel_matrix=kernel_matrix, max_iter=300, tol=1e-4)
